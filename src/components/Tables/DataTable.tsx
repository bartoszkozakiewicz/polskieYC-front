...
const rows = [
  createData(1, 'Cupcake', new Date(),"generate", 67),
  createData(2, 'Donut',  new Date(), "autofill", 51),
  createData(3, 'Eclair', new Date(2024, 9, 15), "generate", 24),
  createData(4, 'Eclair', new Date(2024, 9, 15), "generate", 24),
  createData(5, 'Eclair', new Date(2024, 9, 15), "generate", 24),
  createData(6, 'Eclair', new Date(2024, 9, 15), "generate", 24)
];
...
export default function DataTable() {
  ...
  const handleShowDocument = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.stopPropagation();
  }
  const handleDeleteElement = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.stopPropagation();
    console.log("delete")
  }
  const handleDownloadElement = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.stopPropagation();
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">
                        ...
                        <button className="hover:text-primary"
                            onClick= {(e)=>handleDownloadElement(e)}
                            >
                            <svg
                                className="fill-current"
                                width="20"
